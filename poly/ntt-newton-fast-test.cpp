...
#include "poly/ntt-newton-fast.hpp"

PICOBENCH_SUITE("poly/ntt-newton-fast.hpp");
...
PICOBENCH(poly_ln_bench).iterations(poly_iterations).label("LOG 13E");
...
PICOBENCH(poly_exp_bench).iterations(poly_iterations).label("EXP 17E");
...
PICOBENCH(poly_sqrt_bench).iterations(poly_iterations).label("SQRT 11E");
